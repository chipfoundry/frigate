...
create_clock [get_ports $::env(CLOCK_PORT)]  -name $::env(CLOCK_PORT)  -period 40
create_clock [get_ports {usb_cdc_clk_48MHz}] -name usb_clk -period 20
...
set_driving_cell -lib_cell sky130_fd_sc_hd__clkbuf_4 -pin {X} [get_ports usb_cdc_clk_48MHz]
...
set_clock_latency -min 3.5 [get_clocks $::env(CLOCK_PORT)] -source
